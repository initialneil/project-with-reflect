...
AskUserQuestion for mode (central|in-repo), workstream_mode (worktree|in-repo), optional
machine/device binding, and whether to import existing docs; then run
`scripts/register-project.sh`. Report the new `/<name>` command.
