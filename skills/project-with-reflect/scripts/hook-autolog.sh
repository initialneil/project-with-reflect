#!/usr/bin/env bash
# project-with-reflect — non-blocking auto-log nudges. ALWAYS exits 0; never blocks a
...
#   hook-autolog.sh --context=precompact  # PreCompact → nudge to flush un-logged events first
